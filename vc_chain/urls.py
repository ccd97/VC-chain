...
urlpatterns = [
    ...
    url(r'^user/(?P<username>[\w_]{3,50})/projects/(?P<projectname>[-\w_]{3,50})/(?P<branchname>[-\w_]{3,50})/delete/(?P<filename>[-\w_.]{3,50})/$', views.codeDeleteFile, name="delete-file-request"),
    ...
    url(r'^user/(?P<username>[\w_]{3,50})/projects/(?P<projectname>[-\w_]{3,50})/fork/(?P<forker>[\w_]{3,50})$', views.forkProject, name="project-fork"),
]
